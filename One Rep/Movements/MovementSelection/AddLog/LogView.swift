        ...
        VStack {
            ...
            ScrollView(showsIndicators: false) {
                ...
                .sheet(isPresented: $showEditMovementPopup) {
                    EditMovementView(movement: $movement, showDoneToolBar: $showDoneToolBar)
            ...
            .onAppear {
                ...
                logViewModel.filterLogs(movementId: movement.id)
                logViewModel.populateListOfWeights()
                logViewModel.filterWeightAndPopulateData(movementId: movement.id)
