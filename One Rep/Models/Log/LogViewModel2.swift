...
//import Foundation
//
//class LogViewModel2: ObservableObject {
//    
//    // MARK: - Variables
//    
...
//    @Published var dateMovementLogMap = [String: [String:[Log]]]()
//    
...
//    func populateListOfDates(_ logs: [Log]) {
//        listOfDates = []
//        for log in logs {
...
//    func populateListOfWeights(_ logs: [Log]) {
//        listOfWeights = []
//        for log in logs {
...
//    func populateDateMovementLogMap(_ logs: [Log]) {
//        dateMovementLogMap = [String: [String:[Log]]]()
//        for date in self.listOfDates { /// Create all dict keys with empty lists
//            self.dateMovementLogMap[date] = [String:[Log]]()
//        }
//        for log in logs {
//            let stringDate = formatDate(date: log.date)
//            if dateMovementLogMap[stringDate] != nil {
//                dateMovementLogMap[stringDate]?[log.movementId, default: []].append(log)
//            }
//        }
//    }
//    
//    /// Populate data based on filter for weight
//    func filterWeightAndPopulateData(_ logs: [Log]) {
...
//    }
//    
////    func getAllLogs(_ movements: [Movement]) -> [Log] {
////        let allLogs = [Log]()
